...
public class ProjectController {
	...
	@GetMapping
	public ResponseEntity<?> findByProjectIdentifier(@RequestParam(name = "identifier", required = false) String identifier) {
		return new ResponseEntity<Project>(projectService.findByProjectIdentifier(identifier).get(),HttpStatus.OK);
	}
